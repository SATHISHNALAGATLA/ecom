...
<h1 class="text-center ms-3 h1-far fs-1 mt-4"> EDIT PROFILE</h1>
    <div class="box" style="display: flex;align-items: center;justify-content: space-evenly;">
        ...
        <form action="EditProfile.php" method="post">
            <table align="center">
                ...
                <tr colspan=2>
                    <td colspan=2>
                        <input type="submit" name="confirm" value="Confirm" class="bn53">
                    </td>
                </tr>
            </table>
        </form>
        ...
        <div class="again">
            <a href="ChangePassword.php"><button class="say bn53">Change Password</button></a>
        </div>
