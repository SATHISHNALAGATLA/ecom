            ...
            echo "
                ...
                <div class='card pb-1 pl-1 pr-1 pt-0' style='height:542px'>
                    ...
                    <a href='../BuyerPortal2/ProductDetails.php?id=$product_id'>
                        <img class='card-img-top' src='../Admin/product_images/$product_image' alt= 'Image Not Available' onerror=this.src='../Images/Website/noimage.jpg' height='300px'>
                    </a>
            ...
            echo "<div class='column kolum'>
                <div class='img-thumbnail ''>
                     <a href='../BuyerPortal2/Categories.php?type=$product_type'>
                        <img class='rounded mx-auto d-block images' src='../Admin/product_images//$product_image' width='350px' height='200px' alt='image' alt= 'Image Not Available' onerror=this.src='../Images/Website/noimage.jpg'>
                     </a>
                </div>
            </div>";
        }
    ...
    function getFruitsHomepage()
    {
        ...
        while ($rows = mysqli_fetch_array($run_query)) {
            ...
            echo "<div class='column kolum'>
                <div class='img-thumbnail ''>
                     <a href='../BuyerPortal2/Categories.php?type=$product_type'>
                        <img class='rounded mx-auto d-block images' src='../Admin/product_images//$product_image' width='350px' height='200px' alt= 'Image Not Available' onerror=this.src='../Images/Website/noimage.jpg'>
                     </a>
                </div>
            </div>";
        }
            ...
            while ($row = mysqli_fetch_assoc($run_query)) {
                ...
                echo "
                    <div class='card' width='500px'>
                        ...
                        <img src='../Admin/product_images/$image' alt= 'Image Not Available' onerror=this.src='../Images/Website/noimage.jpg' width='400px' height='300px'>
                        </a>
